...
// 1. Eye आणि EyeOff आयकॉन import करा
...
export default function SignupPage() {
  ...
  // 2. पासवर्ड दिसण्यासाठी नवीन स्टेट
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
             ...
             <div className="space-y-1.5">
                ...
                <input type="email" required className="w-full px-4 h-12 rounded-xl border border-gray-200 focus:ring-2 focus:ring-[#2C6CF2] outline-none transition-all bg-gray-50/50 focus:bg-white" placeholder="name@company.com" />
             </div>
             ...
             <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input 
                    // type बदलला: जर showPassword true असेल तर text, नाहीतर password
                  ...
                  {/* टॉगल बटण */}
                  <button
                    type="button" // हे महत्त्वाचे आहे जेणेकरून फॉर्म सबमिट होणार नाही
